...
stdenv.mkDerivation rec {
  ...
  src = fetchurl ({
    # "i686-linux" = {
    #   url = "http://haskell.org/ghc/dist/${version}/ghc-${version}-i386-unknown-linux.tar.xz";
    #   sha256 = "0gny7knhss0w0d9r6jm1gghrcb8kqjvj94bb7hxf9syrk4fxlcxi";
    # };
    # "x86_64-linux" = {
    #   url = "http://haskell.org/ghc/dist/${version}/ghc-${version}-x86_64-unknown-linux.xz";
    #   sha256 = "043jabd0lh6n1zlqhysngbpvlsdznsa2mmsj08jyqgahw9sjb5ns";
    # };
    # "i686-darwin" = {
    #   url = "http://haskell.org/ghc/dist/${version}/ghc-${version}-i386-apple-darwin.tar.xz";
    ...
    # };
    "aarch64-linux" = {
      url = "http://downloads.haskell.org/~ghc/${version}/ghc-${version}-aarch64-deb8-linux.tar.xz";
